...
export function GlowingEffectDemo() {
  return (
    <ul className="grid grid-cols-1 grid-rows-none gap-4 md:grid-cols-12 md:grid-rows-2 lg:gap-4 xl:grid-rows-2 xl:ml-[25%] md:ml-[25%]">
      <GridItem
        ...
        <div className="border-0.75 relative flex h-full flex-col justify-between gap-6 overflow-hidden rounded-xl p-6 md:p-6 dark:shadow-[0px_0px_27px_0px_#2D2D2D]">
          <div className="relative flex flex-1 flex-col justify-between gap-3">
            ...
            <div className="space-y-3">
              <h3 className="pt-0.5 font-bold text-xl/[1.375rem] text-balance text-black tracking-[-1px] md:text-2xl/[1.875rem] md:tracking-[-2px] dark:text-white">
                {title}
              </h3>
              <h2 className="font-mono font-medium tracking-wide text-sm/[1.125rem] text-black md:text-base/[1.375rem] dark:text-neutral-400">
                {description}
              </h2>
            </div>
          </div>
